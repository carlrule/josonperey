...
<body class="">
    <div class="">
        ...
        <h1 class="text-center" style="font-size: 36px; font-weight: bold;">Choose a timeslot for date:
                ...
                <div class="col-md-2 col-sm-3 col-xs-4 col-6">
                    <center>
                        <?php if (in_array($ts, $bookings)) { ?>
                            <button class="btn btn-danger mb-1 w-100" style="font-size: 15px;">
                                <?php echo $ts ?>
                            </button>
                        <?php } else {
                            ...
                            <?php } else { ?>
                                <button class="btn btn-success book mb-1 w-100" style="font-size: 15px;"
